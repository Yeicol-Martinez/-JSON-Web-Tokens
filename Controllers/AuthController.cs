...
namespace UsuariosAPI.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterRequestDto dto)
        {
            ...
            try
            {
                ...
                var cuenta = new CuentaUsuario
                {
                    ...
                    RefreshTokenExpiry = DateTime.UtcNow.AddDays(refreshExpiryDays)
                };
        ...
        public async Task<IActionResult> Login([FromBody] LoginRequestDto dto)
        {
            ...
            var cuenta = await _context.CuentasUsuario
                .Include(c => c.Usuario)
            ...
            cuenta.RefreshTokenExpiry = DateTime.UtcNow.AddDays(refreshExpiryDays);
            await _context.SaveChangesAsync();
        ...
        public async Task<IActionResult> Refresh([FromBody] RefreshRequestDto dto)
        {
            ...
            {
                return Unauthorized(new { mensaje = "Access token inválido." });
            }
            ...
            if (cuenta == null
                || cuenta.RefreshToken      != dto.RefreshToken
                || cuenta.RefreshTokenExpiry <= DateTime.UtcNow)
            {
            ...
            cuenta.RefreshToken       = newRefreshToken;
            cuenta.RefreshTokenExpiry = DateTime.UtcNow.AddDays(refreshExpiryDays);
            await _context.SaveChangesAsync();
        ...
        {
            var cuenta = await _context.CuentasUsuario
                .FirstOrDefaultAsync(c => c.RefreshToken == dto.RefreshToken);

            if (cuenta != null)
            {
                cuenta.RefreshToken       = null;
                cuenta.RefreshTokenExpiry = null;
                await _context.SaveChangesAsync();
            }
